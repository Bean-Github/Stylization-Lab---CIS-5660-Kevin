...
void GetCutoutData_float(
    out float2 CutoutPos,
    out float CutoutSize,
    out float FalloffSize
)
{
    CutoutPos = _CutoutPos.xy;
    CutoutSize = _CutoutSize;
    FalloffSize = _FalloffSize;
    
}

void GetCutoutData_half(
    out float2 CutoutPos,
    out float CutoutSize,
    out float FalloffSize
)
